...
| **Reordered page** | The card, then the title, watch and bid, then the photos; location, dates, auctioneer and share/catalog buttons below them; the six accordions in a grid; the notices demoted to links at the foot. See [Page layout](#page-layout). |
